...
- (UIView*)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    NSString *retweetButtonTitles = [NSString stringWithFormat:@"%@",[dicStatuesInfo objectForKey:kStatusRepostsCount]];
    ...
    NSString *commentButtonTitle =[NSString stringWithFormat:@"%@",[dicStatuesInfo objectForKey:kStatusCommentsCount]];
    ...
    NSString *attitudesButtonTitle =[NSString stringWithFormat:@"%@",[dicStatuesInfo  objectForKey:kStatusAttitudesCount]];
    ...
    QYSafeRelease(retweetBtn);
    QYSafeRelease(commentBtn);
    QYSafeRelease(attitudesBtn);
