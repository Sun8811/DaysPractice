...
{
    QYEmojiPageView *view = [[QYEmojiPageView alloc] initWithFrame:CGRectMake(0, 100, 220, 100)];
    view.delegate = self;
    [view LoadEmojiItem:10 size:CGSizeMake(30, 30)];
...
{
    NSLog(@"%@",[btnItem titleForState:UIControlStateNormal]);
    self.textView.text = [btnItem titleForState:UIControlStateNormal];
}
- (void)dealloc {
    [_textView release];
    [_btnSend release];
